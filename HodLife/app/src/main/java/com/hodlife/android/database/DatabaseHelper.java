...
public class DatabaseHelper extends OrmLiteSqliteOpenHelper {
    ...
    private Dao<Chat, Integer> simpleDao = null;
    private RuntimeExceptionDao<Chat, Integer> simpleRuntimeDao = null;
     ...
     */
    public RuntimeExceptionDao<Chat, Integer> getSimpleDataDao() {
        if (simpleRuntimeDao == null) {
            simpleRuntimeDao = getRuntimeExceptionDao(Chat.class);
        }
